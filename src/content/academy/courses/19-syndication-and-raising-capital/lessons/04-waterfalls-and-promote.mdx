...
Let's look at typical structures used in real estate syndication.

### Structure 1: Simple pari-passu

Everyone gets distributions in proportion to capital. No promote.
- **All members**: pro rata
- **Sponsor and LPs**: same return
- **Used when**: sponsor invests significant capital and doesn't want a promote
- **Disadvantage**: Doesn't reward sponsor for value creation

This is rarely used in real syndications.

### Structure 2: Pref then split

The most common simple waterfall:
1. **Pref**: 8% per year on capital, pro rata
2. **Above pref**: 80% LP / 20% sponsor

This is simple, easy to explain, and works well for many deals.

### Structure 3: Pref + catch-up + split

A two-tier waterfall:
1. **Pref**: 8% per year on capital, pro rata
2. **Catch-up**: 100% to sponsor until 20% of total distributions
3. **Above**: 80% LP / 20% sponsor

The catch-up means the sponsor's effective promote rises to 20% of all profits (including the pref). This is more sponsor-friendly.

### Structure 4: Tiered promote

Promote increases at higher returns:
1. **Pref**: 8% IRR, pro rata
2. **Tier 1**: 8-12% IRR, 80% LP / 20% sponsor
3. **Tier 2**: 12-18% IRR, 70% LP / 30% sponsor
4. **Tier 3**: Above 18% IRR, 60% LP / 40% sponsor

This rewards exceptional performance heavily.
