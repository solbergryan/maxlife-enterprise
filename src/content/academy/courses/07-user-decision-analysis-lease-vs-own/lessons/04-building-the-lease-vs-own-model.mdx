...
- Discount rate 6% → owning advantage = $640K
- Discount rate 8% → owning advantage = $524K
- Discount rate 10% → owning advantage = $410K
- Discount rate 12% → owning advantage = $295K
...
- 0% appreciation → owning advantage = $115K
- 2% appreciation → owning advantage = $325K
- 3% appreciation → owning advantage = $524K (base)
- 5% appreciation → owning advantage = $950K
...
- 5-year hold → owning advantage = ($35K) ← LEASING WINS
- 7-year hold → owning advantage = $145K
- 10-year hold → owning advantage = $524K (base)
- 15-year hold → owning advantage = $1,150K
