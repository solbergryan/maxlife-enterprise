...
| Layer (top → bottom) | Typical % of stack | Return / cost | Risk | Payback priority |
|---|---|---|---|---|
| **Common equity** (sponsor + LPs) | 20–35% | 15–25%+ IRR target | Highest — first to lose | Last paid |
| **Preferred equity** | 5–15% | 8–12% pref + kicker | High | 4th paid |
| **Mezzanine debt** | 5–15% | 10–14% interest | Medium-high | 3rd paid |
| **Senior debt** | 60–75% | 5–8% interest | Lowest | First paid (1st lien) |
