      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <a
              href="tel:3215862121"
              className="text-gray-300 hover:text-gold text-sm whitespace-nowrap flex items-center gap-1.5 transition-colors"
            >
        ...
        <div className="lg:hidden bg-dark border-t border-white/10">
          <div className="px-4 py-3 space-y-1">
            ...
            <div className="pt-2 space-y-2">
              <a
                href="tel:3215862121"
                className="flex items-center gap-2 text-sm text-gray-300 hover:text-gold transition-colors py-1"
              >
