        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-3">
              ...
              development, and investment services across Central Florida and the
              Space Coast.
            </p>
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="https://www.facebook.com/MaxLifeEnterprise"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="text-gray-500 hover:text-gold transition-colors"
              ...
              <a
                href="https://www.instagram.com/maxlifeenterprise"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.youtube.com/@MaxLifeEnterprise"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="YouTube"
                className="text-gray-500 hover:text-gold transition-colors"
