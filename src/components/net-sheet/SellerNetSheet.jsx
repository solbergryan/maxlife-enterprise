...
import { generateSellerPDF } from "@/components/net-sheet/pdfGenerator";
                  ...
                  <EmailNetSheetButton
                    ...
                    buildImage={() =>
                      generateSellerPDF(salesPrice, loanType, calc, {
                        sellerBrokerFee, buyerBrokerFee, buyerBrokerPaidBy, reissueRate,
                      }, { skipPrint: true })
                    }
                    metadata={{ loanType, sellerBrokerFee, buyerBrokerFee, buyerBrokerPaidBy, reissueRate }}
                  />
                </div>
