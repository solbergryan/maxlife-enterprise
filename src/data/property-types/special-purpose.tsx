...
const golfCourse: PropertyTypeEntry = {
  slug: "golf-course",
  parentSlug: "special-purpose",
  meta: { title: "Golf Courses & Country Clubs for Sale in Florida | Golf Real Estate", description: "Buy golf courses and country clubs in Florida. Daily-fee, semi-private, private club, and resort golf real estate across Orlando and Central Florida.", keywords: "golf course florida, country club for sale, golf course investment, golf real estate orlando" },
  page: {
    ...base,
    displayName: "Golf Course / Country Club",
    pluralDisplayName: "Golf Courses & Country Clubs",
    heroEyebrow: "Golf & Country Club Investments",
    heroHeadline: "Golf Courses & Country Clubs in Florida",
    heroSubheadline: "Daily-fee, semi-private, private club, and resort golf real estate — Florida leads the nation with 1,100+ courses",
    heroBody: "Florida has more golf courses than any other state — over 1,100 courses spanning daily-fee, semi-private, private club, and resort formats. The category represents one of the most land-intensive and operationally complex specialty CRE asset classes. Year-round playability, retiree and snowbird demographics, and world-class tourism give Florida golf a structural advantage over seasonal markets. Deal pricing ranges from distressed daily-fee courses trading at land value ($1M–$5M) to trophy private clubs and resort courses commanding $20M–$100M+. Cap rates are highly variable — 7.0%–10.0%+ for stabilized daily-fee, with private clubs valued on membership economics rather than traditional cap rate analysis.",
    quickStats: [
      { label: "Typical Deal Size", value: "$1M – $100M+", detail: "Distressed daily-fee to trophy private club" },
      { label: "Common Cap Rate", value: "7.0% – 10.0%+", detail: "Daily-fee stabilized; private clubs valued differently" },
      { label: "Avg. Land Area", value: "100 – 250+ acres", detail: "18-hole course plus clubhouse and amenities" },
    ],
    formats: [
      { name: "Daily-Fee / Public", capRate: "8.0% – 10.0%+", footprint: "100 – 180 acres", note: "Open to the public. Revenue driven by green fees, cart rentals, and F&B. Most common acquisition target." },
      { name: "Semi-Private", capRate: "7.5% – 9.0%", footprint: "120 – 200 acres", note: "Membership base plus public tee times. Hybrid revenue model with more predictable cash flow." },
      { name: "Private Club", capRate: "N/A (membership model)", footprint: "150 – 300+ acres", note: "Initiation fees, dues, and assessments. Valued on membership count, waitlist depth, and brand." },
      { name: "Resort / Destination", capRate: "7.0% – 9.0%", footprint: "150 – 500+ acres", note: "Tied to hotel or residential resort. Revenue layered with lodging, spa, real estate sales." },
      { name: "Residential Community Course", capRate: "Varies widely", footprint: "120 – 200 acres", note: "HOA-subsidized or bundled with residential lots. Often sold separately when developer exits." },
    ],
    prosConsIntro: "Golf course real estate offers massive land positions and multiple revenue streams — but operational complexity is real.",
    pros: [
      { title: "Irreplaceable Land Position", description: "100–250+ acres of entitled land in established communities — nearly impossible to replicate under current zoning and environmental regulations." },
      { title: "Multiple Revenue Streams", description: "Green fees, memberships, cart rentals, F&B, pro shop, events, banquets, and real estate development potential." },
      { title: "Redevelopment Optionality", description: "Underperforming courses in growth corridors can be rezoned for residential, mixed-use, or commercial development at significant land-value premiums." },
      { title: "Year-Round Florida Play", description: "No seasonal shutdown — Florida courses generate 12-month revenue while northern courses are dark 4–5 months." },
      { title: "Demographic Tailwinds", description: "Florida's retiree migration, snowbird population, and tourism economy provide durable demand for golf." },
    ],
    cons: [
      { title: "Operationally Intensive", description: "Golf courses require experienced management — superintendents, pro shop staff, F&B, events, and ongoing course maintenance." },
      { title: "High Maintenance CapEx", description: "Irrigation systems, greens renovation, bunker rebuilds, clubhouse HVAC, and cart fleet replacement require ongoing capital investment." },
      { title: "Weather & Water Risk", description: "Hurricanes, drought, and water-use restrictions can impact course condition and playability. Insurance costs are significant." },
      { title: "Declining Participation Trends", description: "Golf participation has been flat to declining nationally for two decades, though Florida has outperformed the national trend." },
      { title: "Entitlement Risk on Redevelopment", description: "Rezoning a golf course for development can face fierce community opposition, environmental review, and political challenges." },
    ],
    personas: [
      { name: "Land Investors", tag: "Redevelopment Play", description: "Investors targeting underperforming courses in growth corridors for residential or mixed-use redevelopment.", fit: "100+ acres of entitled land at golf-course pricing — significant upside if rezoning succeeds." },
      { name: "Hospitality Operators", tag: "Resort Integration", description: "Hotel and resort groups adding golf to their destination amenity portfolio.", fit: "Golf-resort bundles drive room rates, group bookings, and real estate sales." },
      { name: "Golf Management Companies", tag: "Platform Operators", description: "Troon, ClubCorp, Arcis, Concert Golf — management companies building scale.", fit: "Operating expertise turns underperforming courses into cash-flowing assets." },
      { name: "High-Net-Worth Buyers", tag: "Trophy Assets", description: "Wealthy individuals acquiring private clubs or resort courses as legacy investments.", fit: "Trophy golf real estate in premier Florida markets holds generational value." },
    ],
    underwritingIntro: "Golf course underwriting combines hospitality-style operating analysis with land valuation and membership economics.",
    underwritingMetrics: [
      { label: "Rounds Per Year", detail: "Florida benchmark: 35,000–50,000 rounds/year for 18-hole daily-fee. Below 30,000 signals distress." },
      { label: "Revenue Per Round", detail: "Includes green fee, cart, range, F&B, and pro shop. Florida daily-fee averages $45–$85 all-in." },
      { label: "Maintenance Cost Per Hole", detail: "Typical Florida course: $50K–$100K+ per hole annually for turf, irrigation, and grounds." },
      { label: "Clubhouse Condition", detail: "Clubhouse renovation can cost $2M–$10M+. Assess deferred maintenance before closing." },
      { label: "Water Rights & Irrigation", detail: "Florida courses depend on irrigation — verify water use permits, reclaimed water access, and well capacity." },
      { label: "Membership Economics", detail: "Private clubs: initiation fee, monthly dues, F&B minimum, assessment history. Waitlist depth signals demand." },
    ],
    listingSites: specialPurposeListings,
    listingsIntro: "Browse active golf course and country club listings across Florida.",
    faqs: [
      { q: "How much does a golf course cost in Florida?", a: "Prices range enormously — from $1M–$5M for distressed daily-fee courses trading near land value, to $10M–$30M for stabilized semi-private and daily-fee operations, to $50M–$100M+ for trophy private clubs and resort courses. The primary value drivers are location, course condition, membership economics, and redevelopment potential." },
      { q: "Are golf courses good investments?", a: "Golf courses can be excellent investments for operators who understand the business and for land investors targeting redevelopment. As pure passive investments, they are challenging — high operational complexity, significant CapEx requirements, and operator-dependent performance make them unsuitable for passive NNN investors. The best returns typically come from operational turnarounds or land-value redevelopment plays." },
      { q: "Can you redevelop a golf course into housing?", a: "Yes, but it requires rezoning approval which can be politically and environmentally challenging. Many Florida communities were built around golf courses, and residents often oppose development. Environmental review of wetlands, stormwater, and wildlife habitat is typically required. Successful rezoning can unlock enormous land value — 100+ acres in established communities." },
      { q: "How many golf courses are in Florida?", a: "Florida has over 1,100 golf courses — more than any other state. The highest concentration is in South Florida (Palm Beach, Broward, Miami-Dade), Southwest Florida (Naples, Fort Myers), and Central Florida (Orlando metro). The state's year-round playability and retiree demographics support this density." },
      { q: "What is the biggest risk with buying a golf course?", a: "Operational complexity is the primary risk. Golf courses require experienced management teams, ongoing maintenance capital ($50K–$100K+ per hole annually), and are sensitive to weather, water restrictions, and participation trends. For redevelopment plays, entitlement risk — the possibility that rezoning is denied — is the biggest concern." },
    ],
    faqIntro: "Common questions about investing in golf course and country club real estate in Florida.",
    fitCheckIntro: 'If you nod "yes" to three or more of these, golf course real estate may fit your investment strategy.',
    fitCheckQuestions: [
    ...
    leadFormIntro: "Interested in golf course or country club properties in Florida? Tell us your investment criteria and we'll send you current opportunities.",
  },
};
