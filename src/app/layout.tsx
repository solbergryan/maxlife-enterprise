...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Melbourne FL commercial real estate",
    "Cocoa Beach commercial real estate",
    "commercial space for lease Space Coast",
    "office space for lease Melbourne FL",
    "warehouse for lease Brevard",
    "retail space for rent Space Coast",
    "tenant rep Space Coast",
  ],
