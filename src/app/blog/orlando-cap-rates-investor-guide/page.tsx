...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/blog/orlando-cap-rates-investor-guide" },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Orlando Cap Rates: A Guide for CRE Investors", item: "https://maxlifedevelopment.com/blog/orlando-cap-rates-investor-guide" },
  ],
};
...
const articleSchema = {
  "@context": "https://schema.org",
  "@type": "Article",
  headline: "Orlando Cap Rates: A Guide for Commercial Real Estate Investors",
  ...
  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": "https://maxlifedevelopment.com/blog/orlando-cap-rates-investor-guide",
  },
  description:
    "Current cap rates for Orlando commercial real estate by property type. Analysis of NNN, retail, multifamily, industrial, and office cap rate trends.",
};
