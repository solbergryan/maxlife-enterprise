...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "1031 Exchange Rules for Florida Investors", item: "https://maxlifedevelopment.com/blog/1031-exchange-orlando-guide" },
  ],
};
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          ...
          <div className="bg-white/[0.04] border border-white/10 rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-dark rounded-lg p-4 text-center border border-white/10">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-dark-border">
                    <tr>
                      <td className="py-2 pr-4 text-gray-300">Federal Capital Gains (20%)</td>
                      <td className="py-2 px-4 text-right text-red-400">$200,000</td>
                      <td className="py-2 pl-4 text-right text-green-400">$0 (deferred)</td>
                    </tr>
                    <tr>
                      <td className="py-2 pr-4 text-gray-300">Depreciation Recapture (25%)</td>
                      <td className="py-2 px-4 text-right text-red-400">$62,500</td>
                      <td className="py-2 pl-4 text-right text-green-400">$0 (deferred)</td>
                    </tr>
                    <tr>
                      <td className="py-2 pr-4 text-gray-300">NIIT (3.8%)</td>
                      <td className="py-2 px-4 text-right text-red-400">$38,000</td>
                      <td className="py-2 pl-4 text-right text-green-400">$0 (deferred)</td>
                    </tr>
                    <tr>
                      <td className="py-2 pr-4 text-gray-300">State Tax (FL = 0%)</td>
                      <td className="py-2 px-4 text-right text-gray-300">$0</td>
                      <td className="py-2 pl-4 text-right text-gray-300">$0</td>
                    </tr>
