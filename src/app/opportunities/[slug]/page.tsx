        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {deal.upsidePotential && (
              <div className="bg-white/[0.04] border border-gold/20 rounded-xl p-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/[0.04] border border-white/10 rounded-xl p-6 sticky top-24 space-y-6">
              {/* Price */}
              ...
              <div className="border-t border-white/10 pt-4 space-y-3">
                ...
                {deal.crexiUrl && (
                  <a
                    ...
                    className="flex items-center justify-center gap-2 w-full border border-white/10 text-gray-300 hover:text-gold hover:border-gold/40 font-medium py-3 rounded-lg transition-colors text-center text-sm"
                  >
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
