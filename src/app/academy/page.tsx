...
export const metadata: Metadata = {
  ...
  description:
    "A free 20-course commercial real estate curriculum from MaxLife Development. Learn cap rates, underwriting, NNN investing, development, and tax strategy. No credit card required.",
  ...
  openGraph: {
    ...
    url: "https://www.maxlifedevelopment.com/academy",
  },
  keywords: [
